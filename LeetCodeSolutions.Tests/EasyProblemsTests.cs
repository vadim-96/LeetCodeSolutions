...
public class EasyProblemsTests
{
    ...
    public void TestSquaresOfArray(int[] nums, int[] expectedSortedNums)
    {
        var sortedNums = SquaresOfSortedArraySolution.FindSquaresOfEachNumber(nums);

        sortedNums.Should().Equal(expectedSortedNums);
    }
}
